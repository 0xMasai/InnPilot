...
export default function FrontDesk() {
  ...
  useEffect(() => {
    if (!hotelId) return;
    return onSnapshot(hotelCollection(hotelId, COLLECTIONS.BOOKINGS), (snap) => {
